...
parser.add_argument('--pooling', type=str, default='seqnet', help='type of pooling to use', choices=[ 'cosine_seqnet','seqnet', 'smooth', 'delta', 'single','single+seqmatch', 's1+seqmatch','al_seqnet','cosine_al_seqnet'])
